(() => {
  ...
  const injectStyles = () => {
    ...
    style.textContent = `
      .admin-panel{position:fixed;bottom:24px;left:24px;width:320px;max-width:92vw;background:rgba(45,26,45,0.94);color:#f0e8f0;border:1px solid rgba(139,92,246,0.4);border-radius:16px;padding:18px;box-shadow:0 18px 38px rgba(0,0,0,0.4);z-index:9999;font-family:'Inter','Segoe UI',sans-serif;backdrop-filter:blur(12px);}
      ...
      .admin-panel__input{flex:1 1 140px;padding:10px 12px;border-radius:10px;border:1px solid rgba(139,92,246,0.5);background:rgba(20,12,20,0.85);color:#f0e8f0;font-size:14px;}
      .admin-panel__btn{padding:10px 14px;border-radius:10px;border:none;background:linear-gradient(135deg,#8b5cf6,#7c3aed);color:#f3e8ff;font-weight:600;cursor:pointer;transition:transform .15s ease, box-shadow .15s ease;}
      .admin-panel__btn:hover{transform:translateY(-1px);box-shadow:0 12px 20px rgba(139,92,246,0.35);}
      .admin-panel__btn--ghost{background:rgba(139,92,246,0.16);color:#f0e8f0;}
      ...
      .admin-wa-target::after{content:'WA';position:absolute;top:-10px;right:-10px;font-size:11px;background:rgba(139,92,246,0.85);color:#f3e8ff;padding:2px 6px;border-radius:999px;}
